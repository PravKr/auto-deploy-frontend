export const actions = {
  ...
  entitiesValuesByCategoryAndSearchTextLoading:
    "ENTITIES_VALUES_BY_CATEGORY_AND_SEARCH_TEXT_LOADING",
  entitiesValuesByCategoryAndSearchText:
    "ENTITIES_VALUES_BY_CATEGORY_AND_SEARCH_TEXT",
  entitiesValuesByCategoryAndSearchTextError:
    "ENTITIES_VALUES_BY_CATEGORY_AND_SEARCH_TEXT_ERROR",

  // selected values from entities values
  selectedEntitiesValuesByCategory: "SELECTED_ENTITIES_VALUES_BY_CATEGORY",
  selectedEntitiesValuesByCategoryError:
    "SELECTED_ENTITIES_VALUES_BY_CATEGORY_ERROR",
